...
describe("Newsletter signup success", () => {
  it("Signs up valid email to newsletter", () => {
    ...
    cy.get(".lead").should(
      "have.text",
      "There was an error. chris@aol.com Already exists in the newsletter database. Please try again."
    );
  });
  ...
  it("Does not sign up an invalid email to newsletter", () => {
    ...
    cy.get(".lead").should(
      "have.text",
      "There was an error. chris@1.com looks fake or invalid. Please try again."
    );
  });
});
...
describe("Authentication works correctly", () => {
  it("Does not register user without access code", () => {
    ...
    cy.get(".lead").should(
      "have.text",
      "There was an error. Access code is not valid. Please try again."
    );
  });
  ...
  it("Does not log in an unauthenticated user", () => {
    ...
    cy.get(".lead").should(
      "have.text",
      "There was an error. Email or password is incorrect. Please try again."
    );
  });
});
